...
const GeneralInfo = () => {
  ...
  const onImageChange = (name, e) => {
    dispatch(setSpecificationData({ [name]: e?.target?.files }));
  };
                ...
                <Row>
                  ...
                  <Col sm="4" className="mb-1">
                    ...
                    <Input
                      type="file"
                      name="product_images"
                      onChange={(e) => onImageChange(product_images, e)}
                    />
                  </Col>
                  <Col sm="4" className="mb-1"></Col>
                  ...
                  <Col sm="4" className="mb-1">
                    <Label className="form-label" for="product_sku">
                      Product SKU
                    </Label>
                    <Input
                      type="text"
                      ...
                      value={specificationData?.product_sku}
                      onChange={(e) =>
                        onChange({ product_sku: e?.target?.value })
                      }
                      disabled
                    />
                  </Col>
