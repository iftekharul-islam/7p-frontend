...
import { AddTemplate, getEmailTemplateKeywords } from "../store";
      ...
      <Row>
        <Form>
          <Col sm="12">
            <Card>
              <CardHeader>
                <CardTitle tag="h4">New Email Template</CardTitle>
              </CardHeader>
              <CardBody>
                <Row>
                  <Col sm="5">
                    <Row>
                      ...
                      <Col sm="12">
                        ...
                        onEditorStateChange={data => {
                          setValue(data)
                          onChange({target: {name: 'message', value: draftToHtml(convertToRaw(data?.getCurrentContent()))}})
                        }}                         
