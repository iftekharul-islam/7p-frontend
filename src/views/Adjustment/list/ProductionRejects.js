...
import { productionRejectscolumns } from "./productionRejectscolumns";

const ProductionRejects = () => {
  ...
  useEffect(() => {
    dispatch(getProductionRejectsData({ page: currentPage, q: search, sort, sortColumn }));
  ...
  return (
    <div className="react-dataTable">
      <DataTable
        ...
        responsive
        paginationServer
        columns={productionRejectscolumns}
        onSort={handleSort}
        sortIcon={<ChevronDown />}
        className="react-dataTable"
        paginationComponent={CustomPagination}
        data={store.ProductionRejectsData}
        subHeaderComponent={<CustomHeader />}
      />
    </div>
  );
};
export default ProductionRejects;
