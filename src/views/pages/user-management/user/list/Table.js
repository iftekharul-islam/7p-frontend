...
import { downloadExcelSheet, getAllData, getAllDepartment, getAllDesignation, getAllDivision, getAllEmployee, getAllRole } from '../store'
...
// ** Table Header
const CustomHeader = ({ store, toggleSidebar, handlePerPage, rowsPerPage, handleFilter, searchTerm, downloadExcel }) => {
          ...
          <div className='d-flex align-items-center table-header-actions'>
            <UncontrolledDropdown className='me-1'>
              ...
              <DropdownMenu>
                ...
                <DropdownItem className='w-100' onClick={downloadExcel}>
